...
type NightChargeDevicePlan struct {
	...
	MaxTargetSoc              int     `json:"maxTargetSoc"`
	RecommendedTargetSoc      int     `json:"recommendedTargetSoc"`
	RecommendedTargetKWh      float64 `json:"recommendedTargetKwh"`
	RequiredChargeKWh         float64 `json:"requiredChargeKwh"`
	RecommendedACChargeLimitW int     `json:"recommendedAcChargeLimitW"`
	ShouldCharge              bool    `json:"shouldCharge"`
	WouldWrite                bool    `json:"wouldWrite"`
